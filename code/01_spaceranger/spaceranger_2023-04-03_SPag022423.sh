...
## Locate file
SAMPLE=$(awk "NR==${SGE_TASK_ID}" samples_2023-04-03_SPag022423.txt)
...
FASTQPATH=$(ls -d /dcs04/lieber/marmaypag/spatialdACC_LIBD4125/spatialdACC/raw-data/FASTQ/2023-04-03_SPag022423/${SAMPLE}/)
...
date
mkdir -p /dcs04/lieber/marmaypag/spatialdACC_LIBD4125/spatialdACC/processed-data/01_spaceranger/spaceranger_2023-04-03_SPag022423/
mv ${SAMPLE} /dcs04/lieber/marmaypag/spatialdACC_LIBD4125/spatialdACC/processed-data/01_spaceranger/spaceranger_2023-04-03_SPag022423/
