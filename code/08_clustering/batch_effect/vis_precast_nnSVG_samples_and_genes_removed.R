...
load(file = here("processed-data", "08_clustering", "batch_effect", paste0("nnSVG_PRECASTObj_samples_and_genes_removed",K,".Rdata")))
...
precast_name <- paste0("nnSVG_PRECAST_samples_and_genes_removed_captureArea_", K)
