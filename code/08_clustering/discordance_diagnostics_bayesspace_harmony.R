...
write.table(results, file = here::here("processed-data", "08_clustering", "cluster_diagnostics", "fasthplus", "fasthplus_results_bayesSpace_harmony.csv"), append = TRUE, col.names =!file.exists(here("processed-data", "08_clustering", "cluster_diagnostics", "fasthplus", "fasthplus_results_bayesspace_harmony.csv")))
