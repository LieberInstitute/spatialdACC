...
sig_genes_DLPFC <- read.csv(file = here::here("processed-data", "11_differential_expression","pseudobulk", "nnSVG_precast_DE",
                                              paste0("DLPFC_12", "_sig_genes_50.csv")))
...
pdf(file = here::here("plots", "11_differential_expression", "upset_50_DEGs_dACC_DLPFC_12.pdf"), width = 10, height = 10)
upset(upset_data,
...
write.csv(upset_data_table, here("processed-data", "11_differential_expression", "UpSet_table_50_DEGs_DLPFC_12.csv"), row.names = FALSE)
