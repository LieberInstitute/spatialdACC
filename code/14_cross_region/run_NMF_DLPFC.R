...
for (i in 1:100){
    ...
    NMF_i <- colData(spe_DLPFC_12)[, paste0("NMF_", i)]
    layer_guess_reordered <- spe_DLPFC_12$layer_guess_reordered
...
write.csv(kruskal_results, here::here("processed-data", "14_cross_region", "kruskal_NMF_results_DLPFC_12.csv"))
