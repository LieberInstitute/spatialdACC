...
pdf(here("plots", "snRNA-seq", "02_preprocessing", "poisson_deviance.pdf"))
...
#pca plots
pdf(here("plots", "snRNA-seq", "02_preprocessing", "sel_poisson_pearson_GLM_PCA_brain.pdf"))
...
pdf(here("plots", "snRNA-seq", "02_preprocessing", "sel_poisson_pearson_var_explained.pdf"))
...
pdf(file = here::here("plots", "snRNA-seq", "02_preprocessing", "sel_poisson_pearson_UMAP.pdf"))
