...
p1 <- make_escheR(spe_1) |> add_fill(var="nmf15", point_size = 2) |> add_ground(var="layer", stroke=0.3, point_size = 2) +
...
p2 <- make_escheR(spe_1) |> add_fill(var="nmf35", point_size = 2) |> add_ground(var="layer", stroke=0.3, point_size = 2) +
    scale_color_manual(values = c(
        "L2" = "#377EB8",
        "L3" = "#4DAF4A",
        "L5" = "#FFD700",
...
p3 <- make_escheR(spe_2) |> add_fill(var="nmf15", point_size = 2) |> add_ground(var="BayesSpace_harmony_09", stroke=0.3, point_size = 2) +
    scale_color_manual(values = c(
        "L2" = "#377EB8",
        "L3" = "#4DAF4A",
        "L5" = "#FFD700",
