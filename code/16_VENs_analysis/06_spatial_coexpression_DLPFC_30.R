...
# save plots
pdf(here("plots", "16_VENs_analysis", "spatial_coexpression_DLPFC_30.pdf"))
print(p)
...
# save results as csv
write.csv(results, here("processed-data", "16_VENs_analysis", "spatial_coexpression_DLPFC_30.csv"))
