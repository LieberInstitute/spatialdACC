...
img_path = pyhere.here('processed-data', 'Images', 'VistoSeg', 'Capture_areas', 'if-images', '{}.tif')
mask_path = pyhere.here('processed-data', 'VSPG', 'image_processing' ,'01_cellpose', 'cellpose_masks', '{}_mask1.npy')
