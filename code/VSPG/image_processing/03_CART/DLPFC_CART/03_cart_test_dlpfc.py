...
df_path = Path('/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/spot_deconvo/02-cellpose/{}/df_unfiltered.csv')
spot_path = Path('/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/01_spaceranger_IF/{}/outs/spatial/tissue_positions_list.csv')
scale_path = Path('/dcs04/lieber/lcolladotor/spatialDLPFC_LIBD4035/spatialDLPFC/processed-data/01_spaceranger_IF/{}/outs/spatial/scalefactors_json.json')
clusters_path = pyhere.here('processed-data', 'VSPG', 'image_processing','counts', '{}' + '_clusters.csv')
cells_path = pyhere.here('processed-data', 'VSPG', 'image_processing','counts', '{}' + '_cell_metrics.csv')

#   Trained DecisionTreeClassifier path
#model_path = pyhere.here('processed-data', 'VSPG', 'image_processing', 'decision_tree.pkl')
model_path = Path('/dcs04/lieber/lcolladotor/spatialHPC_LIBD4035/spatial_hpc/processed-data/spot_deconvo/groundTruth/03_CART/decision_tree_dacc.pkl')

# os.environ['SLURM_ARRAY_TASK_ID'] = '1'
sample_ids = ['Br6522_Ant_IF', 'Br2720_Ant_IF', 'Br8667_Post_IF', 'Br6432_Ant_IF']
