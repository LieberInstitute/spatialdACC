...
load(here("processed-data", "12_spatial_registration",paste0("DLPFC_manual_",precast_name,".rds")))
...
pdf(file = here("plots","12_spatial_registration","DLPFC_manual",paste0("DLPFC_manual_",precast_name,"_combined",".pdf")))
